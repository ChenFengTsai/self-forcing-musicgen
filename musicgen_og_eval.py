...
# ============================================================
# 1. Pipeline — load pretrained MusicGen-Small
# ============================================================
def load_pretrained_musicgen(device: str = "cuda"):
...
if __name__ == "__main__":
    ...
    ROOT          = "/storage/ssd3/richtsai1103/MusicBench/MusicGen_base"
    ...
    if args.stage in ("generate", "all"):
        model = load_pretrained_musicgen()
